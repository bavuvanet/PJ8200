...
public class DialActivity extends Activity {
	...
	// private String url =
	// "http://www.programvaruteknik.nu/dt031g/dialpad/sounds/";
...
//		initializeButtonArrowClickListeners();
	...
	// boolean toPlay = sp.getBoolean(musicKey,
	// SettingsActivity.OPT_MUSIC_DEFAULT);
	// Log.d(TAG, "running onSharedPreferenceChanged");
	//
	...
	// }
	// catch (Exception e) {
	// Log.d(TAG, "problem med att visa Dialog i InitSoundTask.onPreExecute: " +
	// e.toString());
	// }
	// super.onPreExecute();
	// }
